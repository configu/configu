...
<Frame>![image](/images/webhooks/slack-webhook-payload-uri.png)</Frame>
...
<Frame>![image](/images/webhooks/slack-customize-your-payload.png)</Frame>

Example result:

<Frame>![image](/images/webhooks/slack-result-of-triggering.png)</Frame>