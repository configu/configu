...
- The `depends` property has been removed. If you need to replicate it, you can use the [new `test` property](http://localhost:3000/guides/v1-migration#new-cfgu-property-test).
