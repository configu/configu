...
<Frame>![image](/images/webhooks/discord-webhook-payload-uri-1.png)</Frame>
<br/>
<Frame>![image](/images/webhooks/discord-webhook-payload-uri-2.png)</Frame>
...
<Frame>![image](/images/webhooks/discord-customize-your-payload.png)</Frame>

Example result:

<Frame>![image](/images/webhooks/discord-result-of-triggering.png)</Frame>