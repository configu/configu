...
To assign roles to your [organization members](/platform/members#assign-roles-to-a-member) or [organization tokens](/platform/tokens#assign-roles-to-a-token), go to their respective pages and edit their roles.
