---
title: 'Browser SDK'
description: 'Configu SDK for the Browser published to [npm](https://www.npmjs.com/package/@configu/browser).'
---
...
See [interfaces/sdk/browser/globals](/interfaces/sdk/browser/globals).
