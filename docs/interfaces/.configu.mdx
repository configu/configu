...
For detailed information about the available store options, please refer to the relevant store in the [integrations section](/integrations/overview#configstore).
