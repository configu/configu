...
description: "The `.configu` file is an optional configuration file used by the `Configu CLI` to customize its behavior. The file should be named `.configu` regardless of the format used: JSON or YAML."
---
...
The `.configu` file can be written in one of the following formats: JSON or YAML. Below, you'll find examples of each format using the provided type information.
