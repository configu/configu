...
<Tip>
In case you don't find a `ConfigStore` that meets your requirements, Configu allows you to easily create your own by [implementing a simple abstract class](https://github.com/configu/configu/blob/main/ts/packages/ts/src/ConfigStore.ts) with `get` and `set` methods. This flexibility empowers you to extend Configu and tailor it to your specific configuration management needs.
Please also consider contributing your custom `ConfigStore` back to the community by submitting a pull request to the [Configu GitHub repository](https://github.com/configu/configu).
</Tip>


### Configu

<IntegrationCard data={{...integrations["configu"], description: <p>Enjoy the full power of Configu with our hosted platform.<br/>Authorization, versioning, auditing, visualizations, and more.</p>}} />

### File

Start with the basics: file-based stores.These integrations allow you to accomdate your configuration data within a file in various formats.
