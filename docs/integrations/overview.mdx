...
<Tip>
  ...
  [implementing a simple abstract
  class](https://github.com/configu/configu/blob/main/packages/sdk/src/core/ConfigStore.ts) with `get` and `set`
  methods. This flexibility empowers you to extend Configu and tailor it to your specific configuration management
  needs. Please also consider contributing your custom `ConfigStore` back to the community by submitting a pull request
  to the [Configu GitHub repository](https://github.com/configu/configu).
</Tip>
