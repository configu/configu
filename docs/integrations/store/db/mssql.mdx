---
Below is the same content converted to **MDX** (Markdown + JSX) format. This ensures compatibility with MDX files, allowing for syntax highlighting, embedded components, and enhanced readability.
...
Here’s how to initialize the `MsSQLConfigStore`:
