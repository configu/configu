...
Organization members can be given roles that define what resources they can access. Read more about [role assignment](/integrations/store/configu/authorization#assign-roles) on the authorization page.
...
A member's individual config permissions can be edited and deleted through the config access section. Read more about how to [assign config attributes](/integrations/store/configu/authorization#assign-config-attribute) on the authorization page.
