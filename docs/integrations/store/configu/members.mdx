...
New members are assigned the [default role](/platform/authorization#default-role) from the organization settings.
...
Organization members can be given roles that define what resources they can access. Read more about [role assignment](/platform/authorization#assign-roles) in the authorization page.
...
A member's individual config permissions can be edited and deleted through the config access section. Read more about how to [assign config attributes](/platform/authorization#assign-config-attribute) in the authorization page.
