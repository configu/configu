...
- Share access to ConfigSchema files directly from your repositories with your entire organization and streamline config management via the [Config Editor](/platform/configs-editor).
