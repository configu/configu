...
<Warning>
- Configu will have read-only access to and display all repositories your GitLab account is a member of, including private and group repositories.
- Only a single GitLab account can be connected to a Configu organization.
- If you revoke the GitLab app directly from GitLab, the integration will automatically disconnect in Configu when attempting to access integration features.
