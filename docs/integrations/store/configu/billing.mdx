...
<Note>
  Configu Orchestrator is open-source and free forever. For the Configu Cloud, we offer a generous free Starter plan, which
  we expect will be sufficient for many developer teams. On this page, you can view the details
  of your current plan and upgrade if needed.
</Note>
...
<Warning>
  Please note that any downgrades such as seat removal, changing to a monthly billing interval,
  or removing add-ons, will reduce your billing going forward but will not result in a retroacrtive refund.
</Warning>
