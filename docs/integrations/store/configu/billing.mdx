...
By clicking "Upgrade", you are prompted to select your desired plan. To upgrade to the "Pro" plan, adjust the number of seats, billing interval, and choose the add-ons that match your needs. Click "Upgrade" to proceed. For more details on each plan, visit our [pricing page](https://configu.com/pricing).
