---
title: 'Split'
description: 'Integrates the Configu Orchestrator with [Split](https://help.split.io/hc/en-us).'
---
...
4. Rate limit exceeded
   - Solution: If the API rate limit is exceeded, consider optimizing the frequency of API requests. Monitor Split’s rate limit policies in the [API documentation](https://docs.split.io/reference/rate-limiting).
