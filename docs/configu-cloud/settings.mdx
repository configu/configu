...
<Frame>![image](/images/settings/settings-general-org.png)</Frame>
...
<Frame>![image](/images/settings/settings-general-domains.png)</Frame>
...
<Frame>![image](/images/settings/settings-general-protected-sets.png)</Frame>
...
<Frame>![image](/images/settings/settings-general-upsert-config-request-audit.png)</Frame>
...
<Frame>![image](/images/settings/settings-general-plan.png)</Frame>

## Danger Zone

The following will be visible only to the organization owner.

<Frame>![image](/images/settings/settings-general-danger-zone-owner.png)</Frame>
...
<Frame>![image](/images/settings/settings-general-danger-zone-non-owner.png)</Frame>
