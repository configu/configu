...
<Frame>![image](/images/tokens/tokens-new-token.png)</Frame>

<Info>
A token can optionally be given an expiration date.
</Info>

<Frame>![image](/images/tokens/tokens-pick-expiration.png)</Frame>

<Frame>![image](/images/tokens/tokens-token-created.png)</Frame>
...
<Frame>![image](/images/tokens/tokens-edit-roles.png)</Frame>

<Frame>![image](/images/tokens/tokens-edit-roles-alert.png)</Frame>
...
<Frame>![image](/images/tokens/tokens-revoke-token.png)</Frame>