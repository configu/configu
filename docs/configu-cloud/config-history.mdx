...
<Frame>![image](/images/configs-history/history-sets.png)</Frame>
...
<Tip>  Your organization ID can be found under [organization settings](/settings)</Tip>
...
<Frame>![image](/images/configs-history/history-tags.png)</Frame>

<Frame>![image](/images/configs-history/history-show-diff.png)</Frame>

<Frame>![image](/images/configs-history/history-revert-tag.png)</Frame>
...
<Frame>![image](/images/configs-history/history-explore-tag.png)</Frame>
...
<Frame>![image](/images/configs-history/history-exploration-mode.png)</Frame>
...
<Frame>![image](/images/configs-history/history-exit-exploration-mode.png)</Frame>

### Rollbacks

For every history log entry, you will see a _Revert Changes_ button inside the diff window.

<Frame>![image](/images/configs-history/configs-history-diff.png)</Frame>