...
[core/ConfigStore](https://github.com/configu/configu/blob/main/packages/sdk/src/core/ConfigStore.ts) | [core/stores](https://github.com/configu/configu/blob/main/packages/sdk/src/stores) | [integrations/stores](https://github.com/configu/configu/blob/main/packages/integrations/stores)
...
Under the hood, Configu uses [Acron](https://github.com/acornjs/acorn/tree/master/acorn/) to parse ConfigExpression strings as Javascript and [SES](https://www.npmjs.com/package/ses) to execute it in a secure and strict environment.
...
Under the hood, Configu uses [Acron](https://github.com/acornjs/acorn/tree/master/acorn/) to parse configuration templates as Javascript and [SES](https://www.npmjs.com/package/ses) to execute it in a secure and strict environment.
