...
Configu uses [Acron](https://github.com/acornjs/acorn/tree/master/acorn/) to parse `ConfigExpressions` and [SES](https://www.npmjs.com/package/ses) to execute them in a secure and strict environment.
